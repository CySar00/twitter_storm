...
public class WriteTweetFeedsToMongoDB extends BaseRichBolt {
    ...
    public void execute(Tuple input){
        try{
            ...
            String query="mongoexport --db storm --collection tweet_info --fields tweetID,tweetAuthor,tweet,tweetCreatedAt,tweetHashTags,tweetURLs,tweetUserMentions,inReplyToUserId,followers,friends -o twitterData.txt";
            try{
