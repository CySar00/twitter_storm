 ...
 */
public class WriteTweetFeedsToAMongoDB1 extends BaseRichBolt {
    @Override
    ...
    public void execute(Tuple input) {
        try {
            ...
            DB db = client.getDB("storm_NEW");
            final DBCollection collection = db.getCollection("tweet_info_NEW");
            ...
            String query = "mongoexport --db storm_NEW --collection tweet_info_NEW --fields tweetID,tweetAuthor,tweet,tweetCreatedAt,tweetHashTags,tweetURLs,tweetUserMentions,inReplyToUserId,followers,friends -o tweets.txt";
            try {
