 ...
 */
public class WriteMarvelTweetsToMongoDB extends BaseRichBolt {
    @Override
    ...
    public void execute(Tuple input) {
        try {
            ...
            DB db = client.getDB("storm_marvel");
            final DBCollection collection = db.getCollection("tweet_info_marvel");
            ...
            String query = "mongoexport --db storm_marvel --collection tweet_info_marvel --fields tweetID,tweetAuthor,tweet,tweetCreatedAt,inReplyToUserId,followers,friends -o tweets_marvel.txt";
            try {
