 ...
 */
public class WriteGreekPoliticsTweetsToMongoDB extends BaseRichBolt {
        @Override
        ...
        try {
            ...
            DB db = client.getDB("storm_greekpolitics");
            final DBCollection collection = db.getCollection("tweet_info_greekpolitics");
            ...
            String query = "mongoexport --db storm_greekpolitics --collection tweet_info_greekpolitics --fields tweetID,tweetAuthor,tweet,tweetCreatedAt,inReplyToUserId,followers,friends -o tweets_greekPolitics.txt";
            try {
