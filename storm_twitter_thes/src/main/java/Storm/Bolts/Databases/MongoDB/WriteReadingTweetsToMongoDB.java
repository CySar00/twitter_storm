 ...
 */
public class WriteReadingTweetsToMongoDB extends BaseRichBolt {
    @Override
    ...
    public void execute(Tuple input) {
        try {
            ...
            DB db = client.getDB("storm_reading");
            final DBCollection collection = db.getCollection("tweet_info_reading");
            ...
            String query = "mongoexport --db storm_reading --collection tweet_info_reading --fields tweetID,tweetAuthor,tweet,tweetCreatedAt,inReplyToUserId,followers,friends -o tweets_reading.txt";
            try {
