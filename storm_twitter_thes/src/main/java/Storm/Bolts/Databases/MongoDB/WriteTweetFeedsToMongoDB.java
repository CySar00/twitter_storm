...
public class WriteTweetFeedsToMongoDB extends BaseRichBolt {
    ...
    public void execute(Tuple input) {
        try {
            ...
            final DBCollection collection = db.getCollection("tweet_info_0010");
            ...
            String query = "mongoexport --db storm_NEW_ --collection tweet_info_0010 --fields tweetID,tweetAuthor,tweet,tweetCreatedAt,inReplyToUserId,followers,friends -o tweets_final.txt";
            try {
