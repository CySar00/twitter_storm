package Storm.Databases.CassandraDB.EM;
 ...
 */
public class StatisticsValuesDB {
    ...
    public static String[]getSerializedStatisticsValues(){
    ...
    public static void setSerializedStatisticsValues(int index,String serializedVector){
        CassandraHostConfigurator hostConfigurator=new CassandraHostConfigurator("localhost:9160");
        Cluster cluster=HFactory.getOrCreateCluster("TestCluster", "localhost:9160");
