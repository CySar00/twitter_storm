 ...
 */
public class TwitterTopology_Reading {
    ...
    private static final String[]queryWords={"reading"};
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setBolt("WRITE_TWEET_FEEDS_TO_MONGODB",new WriteReadingTweetsToMongoDB()).globalGrouping("TWITTER_SPOUT");
