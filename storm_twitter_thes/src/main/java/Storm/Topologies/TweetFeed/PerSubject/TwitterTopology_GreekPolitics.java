...
import Storm.Bolts.Databases.MongoDB.WriteGreekPoliticsTweetsToMongoDB;
 ...
 */
public class TwitterTopology_GreekPolitics {
    ...
    private static final String[]queryWords={"syriza","συριζα"};
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setBolt("WRITE_TWEET_FEEDS_TO_MONGODB",new WriteGreekPoliticsTweetsToMongoDB()).globalGrouping("TWITTER_SPOUT");
