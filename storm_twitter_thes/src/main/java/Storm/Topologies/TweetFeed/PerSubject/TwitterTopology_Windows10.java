...
import Storm.Bolts.Databases.MongoDB.WriteReadingTweetsToMongoDB;
import Storm.Bolts.Databases.MongoDB.WriteWindows10TweetsToMongoDB;
...
/**
 * Created by christina on 8/27/15.
 */
public class TwitterTopology_Windows10 {    private static String consumerKey = "KccnMTJrSxl2g9c51cWh9qXPl";
    ...
    private static final String[]queryWords={"windows10"};
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setBolt("WRITE_TWEET_FEEDS_TO_MONGODB",new WriteWindows10TweetsToMongoDB()).globalGrouping("TWITTER_SPOUT");
