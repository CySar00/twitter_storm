package Storm.Topologies.TweetFeed;

import Storm.Bolts.Databases.MongoDB.WriteTweetFeedsToMongoDB;
 ...
 */
public class TweetFeedTopology_FinalQueries {
    ...
    private static final String[]queryWords={"reading","marvel",
                                            "reading festival","windows 10","downtown abbey",
                                            "reading and leeds fest","bastille","simple plan",
                                            "syriza" ,"tsipras","eurogroup","varoufakis","κωνσταντοπούλου",
                                            "ΣΥΡΙΖΑ","τσιπρας","βαρουφακης","εκλογες","grexit","xrimatistirio"};
