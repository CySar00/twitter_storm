 ...
 */
public class DataPointsWithClusterIndexEquals0 extends BaseBasicBolt {
    ...
    public void execute(Tuple input, BasicOutputCollector collector) {
        ...
        if (clusterIndex == 0) {
            if(!theFuckingAuthors.contains(aFuckingAuthor)) {
                ...
                System.out.println(0+aFuckingAuthor + " " + list);
                collector.emit(new Values(0,aFuckingAuthor,list));
