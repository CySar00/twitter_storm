...
public class TweetFeedTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        filterQuery.track(new String[]{ "#FiveWordsToRuinADate"});
        ...
        builder.setBolt("WRITE_TWEET_FEEDS_TO_MONGODB",new WriteTweetFeedsToMongoDB()).shuffleGrouping("TWITTER_SPOUT");
