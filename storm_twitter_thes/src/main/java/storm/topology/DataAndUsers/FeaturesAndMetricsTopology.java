...
public class FeaturesAndMetricsTopology {
    public static void main(String[]args) throws Exception{
        ...
        topologyBuilder.setBolt("CREATE_THE_AUTHORS",new CreateListOfAuthors(),4).shuffleGrouping("READ_THE_AUTHORS");

        topologyBuilder.setBolt("CREATE_USERNAME_AND_LIST_OF_TEXTS",new CreateUserAndListOfTexts(),64).fieldsGrouping("SPLIT_LINES_INTO_TUPLE_FIELD_VALUES",new Fields("USERNAME")).fieldsGrouping("CREATE_THE_AUTHORS",new Fields("USERNAME"));
        ...
        topologyBuilder.setBolt("CALCULATE_EVERY_METRIC_POSSIBLE",new CalculateEveryMetricPossible(),256).fieldsGrouping("SPLIT_LINES_INTO_TUPLE_FIELD_VALUES",new Fields("USERNAME")).fieldsGrouping("CREATE_THE_AUTHORS",new Fields("USERNAME"));
      
        topologyBuilder.setBolt("CALCULATE_EVERY_FEATURE_POSSIBLE", new CalculateEveryFeaturePossible(),256).fieldsGrouping("CALCULATE_EVERY_METRIC_POSSIBLE",new Fields("USERNAME"));
